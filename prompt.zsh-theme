...
ZSH_COLOR_RED=$'%{\e[31m%}'
ZSH_COLOR_BLACK=$'%{\e[30m%}'

ZSH_COLOR_RESET=$'%{\e[0m%}'

ZSH_STATUS_INFO="${ZSH_COLOR_CYAN}$(charHost) %m ${ZSH_COLOR_MAGENTA}$(charUser) %n ${ZSH_COLOR_BLUE}$(charShell) zsh ${ZSH_COLOR_YELLOW}$(charFolder) %d${ZSH_COLOR_RESET}"
ZSH_STATUS_CMD="${ZSH_COLOR_CYAN}$(charPrompt) ${ZSH_COLOR_RESET}"
ZSH_NEWLINE=$'\n'
